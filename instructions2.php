...
<?php
    ...
    $reecipename = mysqli_real_escape_string($connection,$_POST['recipe']);
    $sql_query1 = "SELECT * FROM Recipes WHERE recipe_name = '$reecipename' ";
...
<div class="header">
   ...
   <?php
    $result1 = mysqli_query($connection,$sql_query1);
    $path = mysqli_fetch_assoc($result1)['recipe_image'];
    // print_r($path);
    ?>
